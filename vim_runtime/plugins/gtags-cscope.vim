...
function! s:GtagsCscope()
    ...
    if g:GtagsCscope_Auto_Map == 1
        if g:GtagsCscope_Use_Old_Key_Map == 1
            ...
            "
            " normal command
			" s - symbol: where does the symbol appears
            :nmap <C-\>s :cs find s <C-R>=expand("<cword>")<CR><CR>
			" global definition - the definition of function name, macro ...
            :nmap <C-\>g :cs find g <C-R>=expand("<cword>")<CR><CR>
			" caller - functions calls the function
	...
	" find the files that current symbol appears
